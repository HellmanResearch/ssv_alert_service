...
fn calc_performance(decided_count_option: Option<&u32>, validator_count: u32, days: u32) -> f32 {
    match decided_count_option {
        Some(decided_count) => {
            ...
            let mut performance = decided_count_f32 / (validator_count_f32 * days_f32 * 225.0) * 100.0;
            ...
            Ok((name, owner_address, public_key, validator_count, fee_human, score, is_active)) => {
                ...
                match status_result {
                    Ok(status) => {
                        ...
                        let performance_1day = calc_performance(decided_count_option, validator_count, 1);
